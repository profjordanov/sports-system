    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    HomeBet = table.Column<decimal>(nullable: false),
                    AwayBet = table.Column<decimal>(nullable: false),
                    UserId = table.Column<Guid>(nullable: false),
                    MatchId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMatchBets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserMatchBets_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMatchBets_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMatchBets_MatchId",
                table: "UserMatchBets",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMatchBets_UserId",
                table: "UserMatchBets",
                column: "UserId");
